        ...
        <div class="contenedor-formulario mt-5 pt-5 pb-5">
            ...
            <form action="{{url('briefcomunicacion')}}" method="POST" class="p-5">
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="presencia_online" name="presencia_online" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->presencia_online)?$comunicacion->presencia_online:old('presencia_online') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="servicios_principales" name="servicios_principales" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->servicios_principales)?$comunicacion->servicios_principales:old('servicios_principales') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="publico_objetivo" name="publico_objetivo" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->publico_objetivo)?$comunicacion->publico_objetivo:old('publico_objetivo') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="necesidades_servicios" class="form-label">14. ¿Qué necesidades satisfacen sus productos o servicios?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="necesidades_servicios" name="necesidades_servicios" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->necesidades_servicios)?$comunicacion->necesidades_servicios:old('necesidades_servicios') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="perfil_cliente" name="perfil_cliente" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->perfil_cliente)?$comunicacion->perfil_cliente:old('perfil_cliente') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="competidores_principales" class="form-label">16. ¿Quiénes son sus competidores principales?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="competidores_principales" name="competidores_principales" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->competidores_principales)?$comunicacion->competidores_principales:old('competidores_principales') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="aspectos_competidores" name="aspectos_competidores" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->aspectos_competidores)?$comunicacion->aspectos_competidores:old('aspectos_competidores') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="competidores_indirectos" class="form-label">18. ¿Quiénes son sus competidores indirectos?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="competidores_indirectos" name="competidores_indirectos" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->competidores_indirectos)?$comunicacion->competidores_indirectos:old('competidores_indirectos') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="aspectos_competidores_indirectos" name="aspectos_competidores_indirectos" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->competidores_indirectos)?$comunicacion->competidores_indirectos:old('competidores_indirectos') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="contra_competidores" name="contra_competidores" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->contra_competidores)?$comunicacion->contra_competidores:old('contra_competidores') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="ventajas_competitivas" class="form-label">21. ¿Cuáles son sus principales ventajas competitivas?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="ventajas_competitivas" name="ventajas_competitivas" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->ventajas_competitivas)?$comunicacion->ventajas_competitivas:old('ventajas_competitivas') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="desventajas_competitivas" class="form-label">22. ¿Cuáles son sus principales desventajas competitivas?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="desventajas_competitivas" name="desventajas_competitivas" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->desventajas_competitivas)?$comunicacion->desventajas_competitivas:old('desventajas_competitivas') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="principales_diferenciadores" class="form-label">23. ¿Cuáles son sus principales diferenciadores?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="principales_diferenciadores" name="principales_diferenciadores" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->principales_diferenciadores)?$comunicacion->principales_diferenciadores:old('principales_diferenciadores') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="estrategias_comunicacion" name="estrategias_comunicacion" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->estrategias_comunicacion)?$comunicacion->estrategias_comunicacion:old('estrategias_comunicacion') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="trabajo_con_agencia" name="trabajo_con_agencia" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->trabajo_con_agencia)?$comunicacion->trabajo_con_agencia:old('trabajo_con_agencia') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="nueva_agencia" name="nueva_agencia" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->nueva_agencia)?$comunicacion->nueva_agencia:old('nueva_agencia') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="personalidad_marca" class="form-label">27. ¿Qué personalidad desea darle a su marca?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="personalidad_marca" name="personalidad_marca" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->personalidad_marca)?$comunicacion->personalidad_marca:old('personalidad_marca') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="lenguaje_marca" name="lenguaje_marca" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->lenguaje_marca)?$comunicacion->lenguaje_marca:old('lenguaje_marca') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="presupuesto_anuncios" name="presupuesto_anuncios" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->presupuesto_anuncios)?$comunicacion->presupuesto_anuncios:old('presupuesto_anuncios') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="incrementar_presupuesto" name="incrementar_presupuesto" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->incrementar_presupuesto)?$comunicacion->incrementar_presupuesto:old('incrementar_presupuesto') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="google_ads" class="form-label">31. ¿Utiliza GOOGLE ADS dentro de su estrategia de campañas digitales?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="google_ads" name="google_ads" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->google_ads)?$comunicacion->google_ads:old('google_ads') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea maxlength="500" rows="6" class="form-control" id="conformidad_sitio" name="conformidad_sitio" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->conformidad_sitio)?$comunicacion->conformidad_sitio:old('conformidad_sitio') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="database" class="form-label">33. ¿Cuenta con una base de datos de clientes?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="database" name="database" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->database)?$comunicacion->database:old('database') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="info_importante" class="form-label">34. Agregar toda la información que considere importante resaltar</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="info_importante" name="info_importante" placeholder="Respuesta máxima de 500 caracteres">{{ isset($comunicacion->info_importante)?$comunicacion->info_importante:old('info_importante') }}</textarea>
                </div>
