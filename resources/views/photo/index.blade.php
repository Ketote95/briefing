    ...
    <body class="container">
        <div class="contenedor-formulario mt-5 pt-5 pb-5">
            ...
            <form action="{{url('brief_fotografia')}}" method="POST" class="p-5">
                ...
                <div class="mb-3">
                    <label for="actores" class="form-label">9.  ¿Requiere contratar actores, modelos o figuras públicas para la producción?</label>
                    <textarea maxlength="500" rows="6" class="form-control" id="actores" name="actores" placeholder="Respuesta máxima de 500 caracteres">{{ isset($fotografia->actores)?$fotografia->actores:old('actores') }}</textarea>
                </div>
