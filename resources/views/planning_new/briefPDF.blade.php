...
<html lang="es">
    ...
    <body>
        ...
        {{-- Las preguntas sobre la empresa --}}
        <p class="titulos" style="margin-top: 30px; color: #2F277A"> EMPRESA</p>
        ...
        <table style="font-size: 15px" class="table table-dark table-striped">
            <tbody>
                ...
                @isset($data['comunicacion_servicios'])
                    <tr>
                        <td><li><span>¿Cómo comunica actualmente estos productos o servicios?</span></li></td>
                    </tr>
                    <tr>
                        <td>{{$data['comunicacion_servicios']}}</td>
                    </tr>                    
                @endisset

                @isset($data['comercializacion_servicios'])
                    <tr>
                        <td><li><span>¿Cómo comercializa actualmente estos productos o servicios?</span></li></td>
                    </tr>
                    <tr>
                        <td>{{$data['comercializacion_servicios']}}</td>
                    </tr>                    
                @endisset
